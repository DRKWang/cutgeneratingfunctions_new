...
t1 = Triangle_2(*[Point_2(*acoord) for acoord in [[0, 0], [1, 0], [0, 1]]])
t2 = Triangle_2(*[Point_2(*acoord) for acoord in [[1, 1], [0.5, -1], [0, 1]]])
object = CGAL_Kernel.intersection(t1, t2)
assert object.is_Polygon_2()
print(object.get_Polygon_2())
